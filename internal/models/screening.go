...
// SectorComparison compare une entreprise avec son secteur
type SectorComparison struct {
	Company       Company       `json:"company"`
	SectorAverages SectorAverages `json:"sector_averages"`
	PeerCompanies []PeerCompany  `json:"peer_companies"`
}

// SectorAverages contient les moyennes sectorielles
type SectorAverages struct {
	...
	AvgRevenueGrowth float64 `json:"avg_revenue_growth"`
	CompanyCount    int     `json:"company_count"`
}

// PeerCompany représente une entreprise comparable
